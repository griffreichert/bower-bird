...
Since the antilibrary rewrite (#25) the source node inlines the full body, so
archive/ is a pure recycle bin — the let-go sweep (unread reading-room decay)
retired with the reading rooms themselves.
"""
